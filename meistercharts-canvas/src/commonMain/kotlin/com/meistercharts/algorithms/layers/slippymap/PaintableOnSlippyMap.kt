...
class PaintableOnSlippyMap<out T : Paintable>(
  ...
  fun paint(paintingContext: LayerPaintingContext) {
    @Window val windowX = paintingContext.chartCalculator.domainRelative2windowX(location.longitudeDomainRelative())
    @Window val windowY = paintingContext.chartCalculator.domainRelative2windowY(location.latitudeDomainRelative())
