...
class TankPaintable : Paintable {
  ...
  private val sensorUltrasonic: Paintable = LocalResourcePaintable(Url.relative("tank/sensor-ultrasonic.png"), Size(272.0, 320.0).times(scalingFactor), Coordinates(-272.0 * scalingFactor * 0.5, -286.0 * scalingFactor))
  private val sensorVibration: Paintable = LocalResourcePaintable(Url.relative("tank/sensor-vibration.png"), Size(273.0, 818.0).times(scalingFactor), Coordinates(-273.0 * scalingFactor * 0.5, -286.0 * scalingFactor))
  private val tankCornerBottomLeft: Paintable = LocalResourcePaintable(Url.relative("tank/tank-corner-bottom.png"), Size(602.0, 474.0).times(scalingFactor))
  private val tankCornerBottomRight: Paintable = tankCornerBottomLeft.mirrorOnY()
  private val tankCornerTopLeft: Paintable = LocalResourcePaintable(Url.relative("tank/tank-corner-top.png"), Size(602.0, 518.0).times(scalingFactor))
  private val tankCornerTopRight: Paintable = tankCornerTopLeft.mirrorOnY()
  private val tankSideBottom: Paintable = LocalResourcePaintable(Url.relative("tank/tank-side-bottom.png"), Size(356.0, 474.0).times(scalingFactor))
  private val tankSideTop: Paintable = LocalResourcePaintable(Url.relative("tank/tank-side-top.png"), Size(356.0, 518.0).times(scalingFactor))
  private val tankSideVertical: Paintable = LocalResourcePaintable(Url.relative("tank/tank-side-vertical.png"), Size(80.0, 1892.0).times(scalingFactor))
  private val waves: Paintable = LocalResourcePaintable(Url.relative("tank/waves.png"), Size(1400.0, 82.0).times(scalingFactor), Coordinates(-1400.0 * scalingFactor * 0.5, -82.0 * scalingFactor))
