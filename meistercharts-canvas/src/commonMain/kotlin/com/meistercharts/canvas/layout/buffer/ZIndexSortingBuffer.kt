...
import com.meistercharts.canvas.layout.buffer.ZIndexSortingBuffer.Entry
 ...
 */
class ZIndexSortingBuffer : LayoutVariablesObjectBuffer<Entry>(
  { Entry() }
) {
  /**
  ...
  /**
   * Iterates over all indices - top one first (highest to lowest).
