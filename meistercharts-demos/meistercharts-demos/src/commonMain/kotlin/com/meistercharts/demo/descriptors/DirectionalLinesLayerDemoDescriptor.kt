 ...
 */
class DirectionalLinesLayerDemoDescriptor : ChartingDemoDescriptor<Nothing> {
  override val name: String = "Directional Lines"
    ...
    return ChartingDemo {
      meistercharts {
        ...
        configure {
          ...
          val layer = DirectionalLinesLayer(
            ...
            this.lineEndsAtMode = { config.lineEndsAtModes }
          }
