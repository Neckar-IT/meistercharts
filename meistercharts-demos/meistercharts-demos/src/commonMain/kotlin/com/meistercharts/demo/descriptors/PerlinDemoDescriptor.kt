 ...
 */
class PerlinDemoDescriptor : ChartingDemoDescriptor<Nothing> {
  override val name: String = "Perlin Random Generator"
        ...
        configure {
          ...
          layers.addLayer(object : AbstractLayer() {
            ...
            override fun paint(paintingContext: LayerPaintingContext) {
              ...
              400.fastFor { index ->
                val x = index * 5.0
                @Zoomed val y = perlinNoise.noise(index.toDouble()) * yScale
