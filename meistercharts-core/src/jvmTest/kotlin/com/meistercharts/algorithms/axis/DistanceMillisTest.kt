...
class DistanceMillisTest {
  ...
  fun testIndex() {
    ...
    assertThat(value0.formatUtc()).isEqualTo("2001-09-09T04:05:59.000Z")
    assertThat(value1.formatUtc()).isEqualTo("2001-09-09T04:06:00.000Z")
  ...
  fun testIndex2() {
    ...
    assertThat(value0.formatUtc()).isEqualTo("2001-09-09T01:59:59.900Z")
    assertThat(value1.formatUtc()).isEqualTo("2001-09-09T02:00:00.000Z")
