...
class TimeTickDistanceTest {
  ...
  fun testDistanceHours6() {
    ...
    val ticks = timeTickDistance.calculateTicks(time, end, TimeZone.NewYork)
    assertThat(ticks.size).isEqualTo(8)
    assertThat(ticks[0].formatUtcForDebug()).isEqualTo("2019-01-07T11:00:00.000Z")
    assertThat(ticks[1].formatUtcForDebug()).isEqualTo("2019-01-07T17:00:00.000Z")
    assertThat(ticks[2].formatUtcForDebug()).isEqualTo("2019-01-07T23:00:00.000Z")
    assertThat(ticks[3].formatUtcForDebug()).isEqualTo("2019-01-08T05:00:00.000Z")
    assertThat(ticks[4].formatUtcForDebug()).isEqualTo("2019-01-08T11:00:00.000Z")
    assertThat(ticks[5].formatUtcForDebug()).isEqualTo("2019-01-08T17:00:00.000Z")
    assertThat(ticks[6].formatUtcForDebug()).isEqualTo("2019-01-08T23:00:00.000Z")
  ...
  fun testDistanceHours4() {
    ...
    val ticks = timeTickDistance.calculateTicks(time, end, TimeZone.NewYork)
    assertThat(ticks.size).isEqualTo(9)
    assertThat(ticks[0].formatUtcForDebug()).isEqualTo("2019-01-07T13:00:00.000Z")
    assertThat(ticks[1].formatUtcForDebug()).isEqualTo("2019-01-07T17:00:00.000Z")
    assertThat(ticks[2].formatUtcForDebug()).isEqualTo("2019-01-07T21:00:00.000Z")
    assertThat(ticks[3].formatUtcForDebug()).isEqualTo("2019-01-08T01:00:00.000Z")
    assertThat(ticks[4].formatUtcForDebug()).isEqualTo("2019-01-08T05:00:00.000Z")
    assertThat(ticks[5].formatUtcForDebug()).isEqualTo("2019-01-08T09:00:00.000Z")
    assertThat(ticks[6].formatUtcForDebug()).isEqualTo("2019-01-08T13:00:00.000Z")
    assertThat(ticks[7].formatUtcForDebug()).isEqualTo("2019-01-08T17:00:00.000Z")
