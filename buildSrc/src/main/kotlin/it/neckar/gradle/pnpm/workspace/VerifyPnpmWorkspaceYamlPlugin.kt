...
class VerifyPnpmWorkspaceYamlPlugin : Plugin<Project> {
  override fun apply(target: Project) {
    ...
    val extension = target.extensions.create<VerifyPnpmWorkspaceYamlPluginExtension>("verifyPnpmWorkspaceYaml").apply {
...
open class VerifyPnpmWorkspaceYamlPluginExtension(objects: ObjectFactory) {
  /**
   * Path to the `pnpm-workspace.yaml` to verify. Defaults to `<projectDir>/pnpm-workspace.yaml`.
   */
  val workspaceYamlFile: RegularFileProperty = objects.fileProperty()
