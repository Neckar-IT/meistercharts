...
class DataSeriesIndexProviderBoxingJvmTest {
  ...
  fun testBoxing() {
    ...
    println("CHECK: DataSeriesIndexProviderBoxingTest ###############")
  ...
  fun testBoxingWithDeclaration() {
    ...
    println("CHECK: DataSeriesIndexProviderBoxingTest.withTypeDeclaration ###############")
    println("No boxing/unboxing!!!")
    println("CHECK: ###############")
  ...
  fun testBoxingWithWidenedDeclaration() {
    ...
    println("CHECK: DataSeriesIndexProviderBoxingTest.withTypeDeclarationWide ###############")
    println("No boxing/unboxing!!!")
    println("CHECK: ###############")
  ...
  fun testBoxingWithWidenedDeclarationWildcard() {
    ...
    println("CHECK: DataSeriesIndexProviderBoxingTest.withTypeDeclarationWideWildcard ###############")
    println("No boxing/unboxing!!!")
    println("CHECK: ###############")
