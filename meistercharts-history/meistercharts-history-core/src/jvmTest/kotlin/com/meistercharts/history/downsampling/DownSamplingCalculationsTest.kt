 ...
 */
@file:Suppress("RETURN_VALUE_NOT_USED") // Test scope: return values intentionally discarded
...
class DownSamplingCalculationsTest {
  ...
  fun testIEA() {
    ...
    assertThat(now.formatUtc()).isEqualTo("2020-08-18T13:55:12.367Z")
  ...
  fun testEnumsPriority() {
    ...
    assertThat(chunk.dump(50_000.0, 50_200.0)).isEqualComparingLinesTrim(
      """
          Start: 1970-01-01T00:00:50.005Z
          End:   1970-01-01T00:00:54.995Z
          Series counts:
            Decimals: 0
            Enums:    2
            RefId:    0
          ...
          IDs:                          |            1000            1001  |
             ...
             0 1970-01-01T00:00:50.005Z |           1 (0)        1011 (0)  |
             1 1970-01-01T00:00:50.015Z |           ? (?)           ? (?)  |
             2 1970-01-01T00:00:50.025Z |           ? (?)           ? (?)  |
             3 1970-01-01T00:00:50.035Z |           ? (?)           ? (?)  |
             4 1970-01-01T00:00:50.045Z |           ? (?)           ? (?)  |
             5 1970-01-01T00:00:50.055Z |           ? (?)           ? (?)  |
             6 1970-01-01T00:00:50.065Z |           ? (?)           ? (?)  |
             7 1970-01-01T00:00:50.075Z |           ? (?)           ? (?)  |
             8 1970-01-01T00:00:50.085Z |           ? (?)           ? (?)  |
             9 1970-01-01T00:00:50.095Z |          10 (1)        1100 (2)  |
            10 1970-01-01T00:00:50.105Z |         111 (2)        1111 (3)  |
            11 1970-01-01T00:00:50.115Z |           ? (?)           ? (?)  |
            12 1970-01-01T00:00:50.125Z |           ? (?)           ? (?)  |
            13 1970-01-01T00:00:50.135Z |           ? (?)           ? (?)  |
            14 1970-01-01T00:00:50.145Z |           ? (?)           ? (?)  |
            15 1970-01-01T00:00:50.155Z |           ? (?)           ? (?)  |
            16 1970-01-01T00:00:50.165Z |           ? (?)           ? (?)  |
            17 1970-01-01T00:00:50.175Z |           ? (?)           ? (?)  |
            18 1970-01-01T00:00:50.185Z |           ? (?)           ? (?)  |
            19 1970-01-01T00:00:50.195Z |           ? (?)           ? (?)  |
      """
    )
      ...
      assertThat(chunk.dump(to = 50_150.0)).isEqualComparingLinesTrim(
        """
           ...
           IDs:                          |            1000            1001  |
              ...
              7 1970-01-01T00:00:50.075Z |           ? (?)           ? (?)  |
              8 1970-01-01T00:00:50.085Z |           ? (?)           ? (?)  |
              9 1970-01-01T00:00:50.095Z |          11 (0)        1101 (0)  |
             10 1970-01-01T00:00:50.105Z |         111 (0)       11111 (0)  |
             11 1970-01-01T00:00:50.115Z |           ? (?)           ? (?)  |
             12 1970-01-01T00:00:50.125Z |           ? (?)           ? (?)  |
             13 1970-01-01T00:00:50.135Z |           ? (?)           ? (?)  |
             14 1970-01-01T00:00:50.145Z |           ? (?)           ? (?)  |
